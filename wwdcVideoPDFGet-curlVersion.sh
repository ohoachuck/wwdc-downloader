...
while getopts ":hy:f:s:vo:" opt; do
  case $opt in
    h)
	  	echo "WWDC Videos and PDFs downloader (version ${VERSION})" >&2
      	echo ""
      	...
      	echo "	-o <output path>: path where to download content (default is /Users/${USER}/Desktop/WWDC-2013)" >&2
      	echo ""  >&2
      	echo "Examples:"  >&2
      	echo "	- Download all PDFs and SD videos for 2013:"  >&2
      	echo "  		`basename $0` john.doe@me.com"  >&2
      	echo "	- Download all PDFs and HD videos for 2013:"  >&2
      	echo "  		`basename $0` -f HD john.doe@me.com"  >&2
      	echo "	- Download only session 201, 400 and 401 with SD videos for 2013:"  >&2
      	echo "  		`basename $0` -s 201,400,401 john.doe@me.com"  >&2
      	echo "	- Download only session 201 and 400 with HD video for 2013:"  >&2
      	echo "  		`basename $0` -s 201,400 -f HD john.doe@me.com"  >&2
      	echo "	- Download all PDFs and HD videos for 2013 in /Users/oho/Documents/WWDC-SESSIONS using verbose mode:"  >&2
