...
class wwdcVideosController {
	...
	class func getStringContent(fromURL: String) -> (String) {
		...
		*/
		...
		/* Create the Request:
		My API (2) (GET https://developer.apple.com/videos/play/fall2017/201/)
		https://developer.apple.com/videos/play/fall2017/102/
		*/
		var result = ""
	...
	class func getSessionsList(fromHTML: String) -> Array<String> {
		let pat = "\"\\/videos\\/play\\/fall2017\\/([0-9]*)\\/\""
		let regex = try! NSRegularExpression(pattern: pat, options: [])
		let matches = regex.matches(in: fromHTML, options: [], range: NSRange(location: 0, length: fromHTML.characters.count))
...
let htmlSessionListString = wwdcVideosController.getStringContent(fromURL: "https://developer.apple.com/videos/fall2017/")
...
for (_, value) in sessionsListArray.enumerated() {
	let htmlText = wwdcVideosController.getStringContent(fromURL: "https://developer.apple.com/videos/play/fall2017/" + value + "/")
